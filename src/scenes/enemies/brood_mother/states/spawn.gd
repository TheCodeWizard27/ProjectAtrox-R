...
func spawn(_spawn_scene := spawn_scene) -> void:
	var spawn: Node3D = enemy.spawns[current_brood_size -1].load_in(_spawn_scene)
	spawn.global_position.x = enemy.global_position.x + 1
	spawn.global_position.z = enemy.global_position.z + 1 
